...
public class CustomerControllerTests {
    ...
    public void testReservation() throws Exception {
        mockMvc.perform(get("/customers/reservations"))
                ...
                .andExpect(view().name("reservationList"))
                .andExpect(model().attribute("reservations", reservationRepository.findAll()))
                .andExpect(model().attribute("reservations", hasSize(3)))
                .andExpect(model().attribute("reservations", hasItem(hasProperty("room", is("124")))));
    }
